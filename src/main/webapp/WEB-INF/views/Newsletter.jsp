                ...
                <div class="outer-box rounded">
                    ...
                    <div class="container-md">
                        <div class="row">
                            ...
                            <div class="col-md-5 text-right mx-auto"><a class="text-decoration-none" target="_blank" href="mailto:modikhushil@gmail.com?subject=error report on page: 'New Topic Request'&body=reporting error on page 'New Topic Request'%0D%0A--"><small>Report an issue</small></a></div>
                        </div>
                    </div>
                </div>
            </div>
